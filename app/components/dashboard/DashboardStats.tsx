...
const DashboardStats = async () => {
    ...
    const totalAmount = order.reduce((acc,cur) => acc + cur.amount,0);
    ...
    return (
        <section className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        <p className="text-2xl font-bold">${new Intl.NumberFormat("en-US").format(totalAmount)}</p>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs  text-muted-foreground">Total Sale on OmarShoe</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
